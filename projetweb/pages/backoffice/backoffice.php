...
if ($user['type_utilisateur'] !== 'admin') {
    // Accès refusé, rediriger vers une page d'erreur ou une autre page
    header("Location: /projetweb/pages/tunisfy_sans_conexion/unauthorized.php");
    exit;
}

// 🔹 Liste de tous les utilisateurs (seulement si admin)
            ...
            <tbody id="all-users-table">
                <?php foreach ($users as $user): ?>
                    <tr>
                        <td> <?php echo $counter++ ?></td>
                        <td>
                        <img src="/projetweb/pages/tunify_avec_connexion/<?php echo htmlspecialchars($user['image_path']); ?>" width="70" height="70">
                        </td>
