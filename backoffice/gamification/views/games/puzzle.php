        ...
        <?php if ($currentQuestion): ?>
            ...
            <?php if (!empty($currentQuestion['mp3_path'])): ?>
                <div class="audio-player">
                    ...
                    <audio autoplay>
                        <source src="/tunifiy(gamification)/sources/uploads/audio/<?= $currentQuestion['mp3_path'] ?>" type="audio/mpeg">
                    ...
                    function createPieces() {
                        ...
                        for (let row = 0; row < 3; row++) {
                            for (let col = 0; col < 3; col++) {
                                ...
                                piece.style.backgroundImage = `url('/tunifiy(gamification)/sources/uploads/<?= $currentQuestion['image_path'] ?>')`;
