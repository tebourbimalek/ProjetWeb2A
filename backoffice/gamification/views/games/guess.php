...
<head>
    ...
    <link rel="stylesheet" href="/tunifiy(gamification)/backoffice/gamification/public/assets/css/guess.css">
...
<div class="game-container">
    ...
    <?php elseif ($game['state'] === 'feedback' && $currentQuestion): ?>
        ...
        <?php if ($currentQuestion['image_path']): ?>
            <img src="/tunifiy(gamification)/sources/uploads/<?= $currentQuestion['image_path'] ?>" 
                 class="feedback-image" alt="Question Image">
        <?php endif; ?>
        
        <?php if ($currentQuestion['mp3_path']): ?>
            <audio autoplay src="/tunifiy(gamification)/sources/uploads/audio/<?= $currentQuestion['mp3_path'] ?>"></audio>
        <?php endif; ?>
