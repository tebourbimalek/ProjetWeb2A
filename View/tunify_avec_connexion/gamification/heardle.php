...
if (!isset($_SESSION['heardle_game'])) {
    $db = config::getConnexion(); // Use the provided PDO connection
...
<header>
    <div class="header-buttons">
        ...
        <button onclick="window.location.href='heardle.php?action=restart'">Restart Game</button>
    </div>
...
<?php elseif ($game['state'] === 'playing' && $currentQuestion): ?>
    ...
    <audio id="audio-player" src="/projetweb/View/tunify_avec_connexion/gamification/sources/uploads/audio/<?= $currentQuestion['mp3_path'] ?>" autoplay loop></audio>
...
<?php elseif ($game['state'] === 'feedback' && $currentQuestion): ?>
    ...
    <?php if ($currentQuestion['image_path']): ?>
        <img src="<?= '/projetweb/View/tunify_avec_connexion/gamification/sources/uploads/' . urlencode($currentQuestion['image_path']) ?>" class="feedback-image" alt="Song Image">

    <?php endif; ?>
    <audio autoplay loop src="/projetweb/View/tunify_avec_connexion/gamification/sources/uploads/audio/<?= $currentQuestion['mp3_path'] ?>"></audio>
    <div class="options">
        <?php for ($i = 1; $i <= 4; $i++):
            $class = '';
    ...
    <img src="/projetweb/View/tunify_avec_connexion/gamification/sources/uploads/ppp.png" alt="Tunify Badge" class="tunify-badge">
