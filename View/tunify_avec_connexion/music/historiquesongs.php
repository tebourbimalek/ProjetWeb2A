...
if ($user_id == $playlistId){
    $playlistsusers = getSongsWithStatsSortedByUser($user_id);
    ?>
    <br><br><br><br><br><br><br>
    <div>
        <h3 style="color: white; margin-bottom: -15px;"><strong>Top titres du mois</strong></h3>
...
if ($playlistsusers) {
    ...
    $count = 1;
    foreach (array_slice($playlistsusers, 0, 4) as $song) {
