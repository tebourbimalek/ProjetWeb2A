    ...
    <div class="main-content">
        <div>
            ...
            if (count($playlists) > 0){
                echo '<div class="playlist-card" style="transition: background-color 0.3s ease; max-height: 380px; height: 100%;">';
                    echo '<div style="margin: 0px 5px 0px 0px; display: flex; align-items: center;">';  // Added flexbox
                        ...
                        echo '<input type="text" placeholder="Rechercher une playlist" style="width: 300px; background-color: transparent; border: none; font-size: 16px; margin-left: 10px;">';
                    echo "</div>";  // Closing div for flexbox
                    echo "<br><br>";
                    foreach (array_slice($playlists,0,5) as $playlist) {
                        echo '<div class="playlist-item" style="display: flex; align-items: center;">';
                            echo '<div class="playlist-icon" style="display: flex; align-items: center;">';
                                echo '<div style="background-color: rgb(62, 62, 62); width: 80px; height: 55px; border-radius: 5px; display: flex; align-items: center; justify-content: center; margin-right: 10px;">';
                                    echo '<i class="fa-solid fa-music fa-lg" style="color: white; font-size: 18px;"></i>';  // Music icon with white color
                                echo '</div>';
                                echo '<button id="playlist_info" style="background: none; border: none; color: white; font-size: 16px; font-weight: bold; text-align: left; cursor: pointer;">' . htmlspecialchars($playlist['nom']) . '</button>';
                            echo '</div>';
                        echo '</div>';
                        echo'<br>';
                    }
