...
try {
    ...
    $absolutePath = 'C:/xampp/htdocs/projetweb/View/tunify_avec_connexion/uploads/profile_images/' . $filename;

    // Define relative DB path
    $relativePath = 'C:/xampp/htdocs/projetweb/View/tunify_avec_connexion/uploads/profile_images/' . $filename;
