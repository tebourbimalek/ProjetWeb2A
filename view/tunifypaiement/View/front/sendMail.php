...
require_once 'C:\xampp\htdocs\islem\projetweb\vendor\autoload.php';
...
function sendInvoiceMail($recipientEmail, $recipientName, $transactionId) {
    ...
    try {
        ...
        $mail->Password   = 'kvewqnauykuqnodp';
    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="button-container">
                <a href="http://localhost/islem/projetweb/view/backoffice/facture.php?id={$transactionId}" class="button">
                    Voir ma Facture
                </a>
            </div>
